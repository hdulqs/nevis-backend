...
import dwfe.nevis.test.NevisTestAuth;
import dwfe.nevis.test.NevisTestChecker;
import dwfe.nevis.test.NevisTestClient;
import dwfe.nevis.test.NevisTestUtil;
...
import static dwfe.nevis.test.NevisTestAuthType.SIGN_IN;
import static dwfe.nevis.test.NevisTestAuthorityLevel.USER;
import static dwfe.nevis.test.NevisTestResourceAccessingType.USUAL;
import static dwfe.nevis.test.NevisTestVariablesForIntegrationTest.*;
