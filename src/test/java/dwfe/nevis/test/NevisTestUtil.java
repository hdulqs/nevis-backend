...
import static dwfe.nevis.test.NevisTestAuthType.REFRESH;
import static dwfe.nevis.test.NevisTestResourceAccessingType.BAD_ACCESS_TOKEN;
import static dwfe.nevis.test.NevisTestResourceAccessingType.USUAL;
import static dwfe.nevis.test.NevisTestVariablesForAuthTest.AUTHORITY_to_AUTHORITY_STATUS;
import static dwfe.nevis.test.NevisTestVariablesForAuthTest.AUTHORITY_to_AUTHORITY_STATUS_BAD_ACCESS_TOKEN;
import static dwfe.nevis.util.NevisUtil.getJsonFromObj;
